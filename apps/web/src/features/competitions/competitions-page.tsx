...
function resolveEmptyAutoAssignMessage(
  ...
  return "Не удалось определить категорию ни для одного соревнования. Проверьте, что у парков заполнены рейтинг и количество корзин, а диапазоны категорий покрывают эти соревнования.";
}
